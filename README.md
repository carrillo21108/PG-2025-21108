...
- **Documentación Completa**: Trabajo de graduación en [docs/Trabajo de Graduación - Brian Carrillo.pdf](docs/Trabajo%20de%20Graduación%20-%20Brian%20Carrillo.pdf)
...
1. Clonar el repositorio:
   ```bash
   git clone https://github.com/tu-usuario/PG-2025-21108.git
   cd PG-2025-21108/src/android-app
   ```
...
**Brian Anthony Carrillo Monzón** - 21108 - Proyecto de Graduación 2025  
